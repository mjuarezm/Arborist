...
pybrg_src_dir = 'ArboristBridgePy'
pyx_src_dir = path.join(pybrg_src_dir, 'pyborist')
cc_src_dir = 'ArboristCore'

PKGNAME = 'pyborist'
DESCRIPTION = 'a Random Forest library'
with open(path.join(pybrg_src_dir, 'README.rst')) as f:
